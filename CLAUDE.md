...
Next up: Phase 5 (local AI via Foundation Models), Phase 6 (polish & ship: sounds, accessories, launch-at-login, notarized DMG). See the plan in `.claude/plans/`.
