...
- **Phase 3 (smart reactions):** download/install celebrations, typing companion (sits + watches your keyboard), idle sleep/wake, sit-on-Terminal coding-agent celebration via the Stop-hook deep link + AX positioning, "Superpowers" permissions submenu.

Next up: Phase 4 (productivity: notes/reminders/Pomodoro), Phase 5 (local AI via Foundation Models). See the plan in `.claude/plans/`.
